...
<BlogHeader/>
    ...
    <div className="flex justify-center items-center">
        ...
        <div className="flex flex-col    p-6 ">
                ...
                <p className=" text-gray-600 mt-2 text-sm">Edit the blog post.</p>
            ...
            <div className="flex flex-col    p-6 -mt-7">
             ...
             <Input type="search" className='text-gray-600 mt-2 text-sm ' placeholder={first.blogTitle}/>
            </div>
            ...
            <div className="flex flex-col    p-6 -mt-7">
             ...
             <Input type="search" className='text-gray-600 mt-2 text-sm  ' placeholder={first.caption}/>
            </div>
...
<div className=" mt-2 text-sm          ">
        ...
        <div className="flex justify-end items-end h-10 mr-5 ">
          <Button className='bg-blue-600 text-white  hover:bg-blue-800 hover:text-white ml-3' onClick={handleOnsave}>Save Changes</Button>
          <Button className='ml-12 bg-blue-600 text-white  hover:bg-blue-800 hover:text-white' onClick={handleOnclear}>Clear</Button>
       </div>
        </div>
        </div>

...
import facebook from "../Registration_Successful/Facebook.svg"
import twitter from "../Registration_Successful/Twitter.svg"
import insta from "../Registration_Successful/Instagram.svg"
...
const contact:React.FC<topimgprop>=({title}) =>{
    const [info,setInfo]=useState({fname:"", lname:"",phone:"",email:"",subject:""});
        ...
        <form className=' w-full '>
          <div className="grid w-full items-center  gap-y-4">
            ...
            <div className="flex flex-col  space-y-1.5 w-1/2">
              ...
              <Input id="fname" placeholder="Max"      onChange={handleChange}
            required />
            </div>
            <div className="flex flex-col space-y-1.5 w-1/2">
              <Label htmlFor="lname">Last Name</Label>
              <Input id="lname" placeholder="Robbinson"      onChange={handleChange}
            required />
            </div>
            </div>
            <div className="flex flex-col space-y-1.5">
              <Label htmlFor="phone">Phone Number</Label>
              <Input id="phone" placeholder="+977 9876543210"      onChange={handleChange}
            required />
            </div>
            <div className="flex flex-col space-y-1.5">
              <Label htmlFor="email">Email</Label>
              <Input id="email" placeholder="m@example.com"      onChange={handleChange}
            required/>
            </div>
            <div className="flex flex-col space-y-1.5">
              <Label htmlFor="subject">Subject</Label>
              <Input id="subject" placeholder="Lorem Ipsum"      onChange={handleChange}
            required />
            </div>
            <div className="flex flex-col space-y-1.5">
              <Label htmlFor="mssg">Write a message</Label>
              <Textarea id="mssg" placeholder="Minimum 100 words" className='min-h-28' onChange={(e)=>e.target.value}/>
            </div>
          </div>
        </form>
      </CardContent>
      <CardFooter className="">
        <Button  className='w-full bg-blue-700 hover:bg-blue-900'>Send a message</Button>

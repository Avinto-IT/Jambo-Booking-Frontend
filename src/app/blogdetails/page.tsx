      ...
      <div className="filters flex justify-between items-center 
        ...
        <Tabs defaultValue="All" className=" w-20 h-10 p-1 rounded-md ">
          <TabsList>
            ...
            <TabsTrigger value="Inactive" onClick={()=> setActiveTab("Inactive")}>Inactive</TabsTrigger>
          </TabsList>
        </Tabs>
        ...
        <div className="buttons gap-2 h-8 w-50  ">
          ...
          <Button asChild className="bg-blue-600 hover:bg-blue-800  h-8">
             <a href="http://localhost:3000/addBlogs">
      ...
      <div className="flex  flex-col      bg-white mt-4 rounded-lg shadow-md">
        ...
        <div className="searchrow flex flex-row       h-28 mb-2">
            ...
            <div className="flex flex-col  gap-1.5 p-6">
                ...
                <p className=" text-gray-600 mt-2 text-sm">Manage your blogs and view their status performance.</p>

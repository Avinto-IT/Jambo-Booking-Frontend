...
import eclipse from "@/components/Logins/Ellipse 1.svg";
import { Button } from '@/components/ui/button';
import Jambologo from './Vector (2).svg'
  ...
  return (
    ...
    <main className="flex-grow max-w-[1920px] justify-center items-center">
      ...
      <Lottie animationData={animationdata} loop={true} />
            ...
            <p className=" text-3xl font-bold leading-9 my-2">Registration Successful!</p>
            <div className="text-sm text-[#64748B] text-center w-2/3  leading-5 "><p className="">Thank you for registering your agency with Jambo Hotels.</p><br/>

            <p className="">Your registration details have been received and are currently under review. Our team will review your submission to ensure it meets our criteria for agency accounts. This process typically takes 1-2 business days. Once your account is approved, you will receive a confirmation email with further instructions on how to access and utilize your new account.
            </p>
            </div>
            <Button className="w-1/4 bg-blue-700 hover:bg-blue-900 mt-10 py-4" onClick={()=>( window.location.href = "/")}>
            Back to Home
          </Button>
        </div>
    </main>

                    ...
                    return (
                      ...
                      >
                        <div>
                          ...
                          x <span className="font-semibold">{daysBooked}</span>{" "}
                          Nights x{" "}
                          <span className="font-semibold">
                            {bookInfo.rooms}
                          </span>{" "}
            ...
            <Card className="shadow-none rounded-md border-2">
              ...
              <CardContent className="flex flex-col gap-y-4">
                <div>
                  ...
                  <div className="rounded border px-3 py-1.5 capitalize">
                    {booking.status}
                  </div>
                </div>
                <div>
                  <div className="font-medium">Remarks from Jambo</div>
                  <div className="rounded border px-3 py-1.5 min-h-10">
                    {bookingRemarks}
                  </div>
                </div>
              </CardContent>

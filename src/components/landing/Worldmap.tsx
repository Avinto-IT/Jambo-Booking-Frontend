...
import world from "./Locations.svg"
    ...
    <div className='flex justify-center items-center mt-10  text-[#0F172A] '>
      <MaxWidthWrapper className='py-20'>
        <div className=" bg-[#F0FDF4] w-full flex justify-center items-center   rounded-2xl">
            ...
            <p className="font-semibold text-3xl leading-10 tracking-tight">Find Your Hotels</p>
            <p className="mt-4 leading-7">Find your desired hotel near your desired trip location</p>
            </div>
            <Image src={world} alt="locations" className=' gap-2.5 pb-14 pt-5 px-20'/>
            </div>
        </div>

...
import fivestar from "./logos/Group 10490.svg"
import one from "./logos/Group 10577.svg"
import two from "./logos/Group 10578.svg"
import three from "./logos/Group 10579.svg"
import four from "./logos/Group 10580.svg"
            ...
            <div className="w-1/3 gap-20 mt-7">
                <div className="gap-6">
                    ...
                    <div className="gap-2.5 w-52 h-14 flex  flex-col justify-evenly  mt-5 ">
                        ...
                        <p className="text-[#0F172A] opacity-[70%] font-semibold">Excellent 5000+ agents</p>
                ...
                <div className="bg-white hover:shadow-xl flex justify-center items-center p-6 pr-7">
                    <div className="gap-15  pt-5">
                        ...
                        <div className="w-72 h-24 gap-2.5 mt-1.5">
                            ...
                            <p className="text-sm opacity-30 mt-1.5 leading-7">Amet minim mollit non deserunt ullamco est sit aliqua dolor do</p>
                        </div>
                    </div>
                </div>
                <div className="bg-white hover:shadow-xl flex justify-center items-center p-6 pr-7">

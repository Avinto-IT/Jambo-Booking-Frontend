      ...
      <MaxWidthWrapper className=' '>
        ...
        <div className="mainbody flex  ">
          {limitedData.length > 0 && (
            <div className="left w-1/2 mr-3" onClick={() => handleBlogClick((limitedData[0].ID))}>
          ...
          <div className="right w-1/2 ml-3">
            {limitedData.length > 1 && limitedData.slice(1, 3).map((blog) => (
              <div key={blog.POST_ID} className="one h-1/2 flex pb-3 mb-3" onClick={() => handleBlogClick((blog.ID))}>

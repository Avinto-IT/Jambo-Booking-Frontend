...
const Set_New_Password: React.FC<SetNewPasswordProp> = ({ onButtonClick }) => {
  ...
  const handleChangePassword=()=>{
    ...
    if(password.newpassword===password.repassword && passwordRegex.test(password.newpassword))
    onButtonClick();
  else{
  ...
  <div className="w-full flex place-content-center place-items-center">
    <div className="w-full max-w-sm  ">
      <CardHeader>
        <CardTitle className="text-3xl leading-10">Set a new password </CardTitle>
        <CardDescription>
      ...
      <CardContent className="grid gap-4">
        ...
        <div className="grid gap-2">
          <Label htmlFor="email" className="font-semibold">Confirm Password</Label>
          <Input
            id="repassword"
            name="repassword"
            type="password"
      ...
      {/* <CardFooter> */}
        <Button  className="w-full bg-blue-600 hover:bg-blue-800" onClick={handleChangePassword}>
          Change Password
        </Button>
